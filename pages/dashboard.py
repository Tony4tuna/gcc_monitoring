...
def generate_service_order_pdf(ticket_id: int) -> Tuple[str, bytes]:
    """Generate service order PDF using centralized ticket_document module."""
    from core.ticket_document import generate_ticket_pdf
    return generate_ticket_pdf(ticket_id)
